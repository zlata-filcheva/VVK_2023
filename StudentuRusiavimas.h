...
const string randomMarksResult = "Paspauskite 1, kad sugeneruotumėte atsitiktinius ženklus. Paspauskite kitą, kad duomenis įvestumėte rankiniu būdu";
const string homeworkCountQuestion = "Kaip norėtumėte skaičiuoti namų darbų pažymius (vidurkis arba mediana)?";
const string homeworkCountAnswer = "Paspauskite 1, kad gautumėte rezultatus pagal vidurkį. Paspaudus dar ką nors, rezultatai bus skaičiuojami pagal medianą";
